    ...
    public class CustomMessageBox : Window
    {
        ...
        private void InitializeComponents(string message)
        {
            ...
            _messageText = new TextBlock
            {
                ...
                TextWrapping = TextWrapping.Wrap, // Wrap text if it's too long
            ...
            _okButton.PointerEntered += (_, _) => _okButton.Background = Brushes.Black;
            _okButton.PointerExited += (_, _) => _okButton.Background = Brushes.LightGray;
            _okButton.PointerPressed += (_, _) => _okButton.Background = Brushes.DarkGray;
